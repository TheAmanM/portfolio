...
export default function Navbar(props: { hasBG?: boolean | undefined }) {
  ...
  return (
    <>
      <div
        className={`flex px-12 max-md:px-6 py-6 items-center justify-between w-screen fixed z-999 ${
          props.hasBG && " bg-white"
        }`}
      >
        <a href="/">
        ...
        >
          <svg
            ...
            viewBox="0 0 512 512"
            onClick={toggleDrawer}
            className="size-8 mr-6 ml-auto mb-4 md:hidden cursor-pointer"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
              fill="none"
      ...
      {props.hasBG && <div className="h-[4.75rem]" />}
    </>
  );
}
